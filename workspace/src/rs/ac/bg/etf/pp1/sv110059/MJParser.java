...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Tue Feb 03 23:31:03 CET 2015
  */
public class MJParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short[][] _action_table = 
    ...
    "\010\uff87\024\uff87\027\uff87\051\uff87\052\uff87\053\uff87\055" +
   ...
   // o.setAdr(adr);
	...
	if (!g) {
		if (dest.getType() == Tab.find("string").getType()) {
			...
			Code.loadConst(-11); //to XXX
			

			Code.put(Code.store_1);//allocate array
			Code.put(Code.newarray);
			Code.loadConst(0);
			Code.put(Code.load_2); //address of array
			...
			Code.loadConst(21); //to ZZZ //TODO: odrediti koliko je do ZZZ
